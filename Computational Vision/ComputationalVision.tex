...
\begin{document}
	...
	Initially, we have to figure out how to learn eigenfaces. A method called principle components analysis (PCA)\index{principle components analysis}. In order to use this we have to understand what an eigenvector\index{eigenvector} is and also what covariance\index{covariance} is.
